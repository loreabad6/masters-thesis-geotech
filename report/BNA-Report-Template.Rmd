...
* `r ifelse(area_type == "osm",paste("The size of the osm data for your study area is", round(osm_size,2), "MB and the"),"The")` analysis took **`r round(as.numeric(duration),2)` minutes** to run.
...
```{r verify_area, echo = FALSE}
library(tmap)
tmap_mode("view")
qtm(boundary, borders = "red", fill = NULL, basemaps = "OpenStreetMap")
```

```{fetch, include = FALSE, cache = FALSE}
```
