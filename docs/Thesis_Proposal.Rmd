...
Additionally, the final report was submitted as a [short paper](https://drive.google.com/file/d/1Hf_sS92RgMJxF5Jo0FhBJdH9_C0sFtcw/view?usp=sharing) to the [Open Data for Open Cities](http://opendata4opencities.uji.es/agendalund/) Second edition of AGILE 2018 Workshop in Lund, Sweden. From the workshop participants suggestions a paper, currently in revision, was drafted, mentioning the following future work:
